...
#[derive(Debug)]
pub struct GanacheDappProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GanacheDappProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GanacheDapp processing");
    
    let mut processor = GanacheDappProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GanacheDappProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GanacheDappProcessor::new(false);
